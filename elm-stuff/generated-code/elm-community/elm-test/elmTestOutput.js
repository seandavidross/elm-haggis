...
var _user$project$Haggis_Deck$wilds = {
	ctor: '::',
...
var _user$project$Tests$dealTestHand = function () {
	var seed = _elm_lang$core$Random$initialSeed(4);
	var _p0 = A2(_user$project$Haggis_Deck$shuffle, seed, _user$project$Haggis_Deck$stock);
	var deck = _p0._0;
	var _p1 = A2(_user$project$Haggis_Deck$deal, 14, deck);
	var hand = _p1._1;
	var sortedHand = A2(_elm_lang$core$List$sortWith, _user$project$Haggis_Card$cardOrdering, hand);
	return {ctor: '_Tuple3', _0: seed, _1: deck, _2: sortedHand};
}();
											...
											_1: {
												...
												_0: A2(
													...
													function (_p113) {
														...
														var seed = _elm_lang$core$Random$initialSeed(1);
														var _p115 = A2(_user$project$Haggis_Deck$shuffle, seed, stock);
														return A2(_elm_community$elm_test$Expect$equal, _p115._0, shuffled);
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														function (_p116) {
															...
															var stock = _user$project$Tests$hand;
															var seed = _elm_lang$core$Random$initialSeed(1);
															var _p118 = A2(_user$project$Haggis_Deck$deal, 3, stock);
															return A2(
																_elm_community$elm_test$Expect$equal,
																_p118._1,
																{
													...
													_1: {
														...
														_0: A2(
															...
															function (_p119) {
																...
																var stock = _user$project$Tests$hand;
																var seed = _elm_lang$core$Random$initialSeed(1);
																var _p121 = A2(_user$project$Haggis_Deck$deal, 3, stock);
																return A2(
																	_elm_community$elm_test$Expect$equal,
																	_p121._0,
																	{
														...
														_1: {
															...
															_0: A2(
																...
																function (_p122) {
																	...
																	var stock = _user$project$Tests$hand;
																	var seed = _elm_lang$core$Random$initialSeed(1);
																	var _p124 = A2(_user$project$Haggis_Deck$deal, -3, stock);
																	return A2(
																		_elm_community$elm_test$Expect$equal,
																		_p124._1,
																		{ctor: '[]'});
															...
															_1: {
																...
																_0: A2(
																	...
																	function (_p125) {
																		...
																		var stock = _user$project$Tests$hand;
																		var seed = _elm_lang$core$Random$initialSeed(1);
																		var _p127 = A2(_user$project$Haggis_Deck$deal, -3, stock);
																		return A2(_elm_community$elm_test$Expect$equal, _p127._0, stock);
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		function (_p128) {
																			...
																			var stock = _user$project$Tests$hand;
																			var seed = _elm_lang$core$Random$initialSeed(1);
																			var _p130 = A2(_user$project$Haggis_Deck$deal, 15, stock);
																			return A2(_elm_community$elm_test$Expect$equal, _p130._1, stock);
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			function (_p131) {
																				...
																				var stock = _user$project$Tests$hand;
																				var seed = _elm_lang$core$Random$initialSeed(1);
																				var _p133 = A2(_user$project$Haggis_Deck$deal, 15, stock);
																				return A2(
																					_elm_community$elm_test$Expect$equal,
																					_p133._0,
																					{ctor: '[]'});
																		...
																		_1: {
																			...
																			_0: A2(
																				_elm_community$elm_test$Test$test,
																				'find out which cards get dealt to hand from full deck',
																				function (_p134) {
																					var _p135 = _p134;
																					var _p136 = _user$project$Tests$dealTestHand;
																					var seed = _p136._0;
																					var deck = _p136._1;
																					var hand = _p136._2;
																					return A2(
																			...
																			_1: {
																				...
																				_0: A2(
																					_elm_community$elm_test$Test$test,
																					'find all sets in hand dealt from full deck',
																					function (_p137) {
																						var _p138 = _p137;
																						var _p139 = _user$project$Tests$dealTestHand;
																						var seed = _p139._0;
																						var deck = _p139._1;
																						var hand = _p139._2;
																						return A2(
																							_elm_community$elm_test$Expect$equal,
																							_user$project$Haggis_Hand$collectSets(hand),
																							{
																								ctor: '::',
																								_0: _user$project$Haggis_Combination$Pair(_user$project$Haggis_Card$Two),
																								_1: {
																														...
																														_1: {
																															...
																															_1: {
																																...
																																_1: {
																																	...
																																	_1: {
																																		ctor: '::',
																																		_0: _user$project$Haggis_Combination$Pair(_user$project$Haggis_Card$Four),
																																		_1: {
																																			ctor: '::',
																																			_0: _user$project$Haggis_Combination$Single(_user$project$Haggis_Card$Four),
																																			_1: {
																																				...
																																				_1: {
																																					ctor: '::',
																																					_0: _user$project$Haggis_Combination$Single(_user$project$Haggis_Card$Six),
																																					_1: {
																																						ctor: '::',
																																						_0: _user$project$Haggis_Combination$Single(_user$project$Haggis_Card$Seven),
																																						_1: {
																																							ctor: '::',
																																							_0: _user$project$Haggis_Combination$Pair(_user$project$Haggis_Card$Eight),
																																							_1: {
																																								ctor: '::',
																																								_0: _user$project$Haggis_Combination$Single(_user$project$Haggis_Card$Eight),
																																								_1: {
																																									ctor: '::',
																																									_0: _user$project$Haggis_Combination$Single(_user$project$Haggis_Card$Eight),
																																									_1: {
																				...
																				_1: {
																					...
																					_0: A2(
																						_elm_community$elm_test$Test$test,
																						'find all sequences in hand dealt from full deck',
																						function (_p140) {
																							var _p141 = _p140;
																							var _p142 = _user$project$Tests$dealTestHand;
																							var seed = _p142._0;
																							var deck = _p142._1;
																							var hand = _p142._2;
																							return A2(
																								_elm_community$elm_test$Expect$equal,
																								_user$project$Haggis_Hand$collectSequences(hand),
																								{
																									ctor: '::',
																									_0: A2(_user$project$Haggis_Combination$RunOfSingles, 3, _user$project$Haggis_Card$Eight),
																									_1: {ctor: '[]'}
																								});
																						}),
																					_1: {ctor: '[]'}
